...
\begin{tikzpicture}[inner sep=0in,outer sep=0in]
	...
	draw \node[circle, draw = black, ultra thick, minimum size=15pt, fill] at (2,12) (x_1^3 = x_2^3) {};
	...
	\draw[black,ultra thick] (x_1^2)--(x_1^3 = x_2^3);
	\draw[black,ultra thick] (x_2^2)--(x_1^3 = x_2^3);
\end{tikzpicture}
\end{document}