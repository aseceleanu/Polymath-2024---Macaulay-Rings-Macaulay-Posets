...
\begin{tikzpicture}[inner sep=0in,outer sep=0in]
	...
	draw \node[circle, draw = black, ultra thick, minimum size=15pt, fill] at (0,12) (x_1^3) {};
	draw \node[circle, draw = black, ultra thick, minimum size=15pt, fill] at (4,12) (x_2^3) {};
	
	
	draw \node[circle, draw = black, ultra thick, minimum size=15pt, fill] at (2,16) (x_1^4=x_2^4) {};
	...
	\draw[black,ultra thick] (x_1^3)--(x_1^4=x_2^4);
	\draw[black,ultra thick] (x_2^3)--(x_1^4=x_2^4);
\end{tikzpicture}
\end{document}